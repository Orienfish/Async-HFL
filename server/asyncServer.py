...
class AsyncServer(SyncServer):
    ...
    def server_warmup(self):
        ...
        self.grads = np.array(self.grads)  # (num of clients, num of weights dim)
        ...
        if self.config.pca_dim > 0:
            ...
            self.grads = self.pca.fit_transform(self.grads)  # (num of clients, pca dim)
    ...
    def run(self, logger=None):
        ...
        for round in range(1, rounds + 1):
            ...
            logging.info('Select gateway {}, time {} s, test loss: {}, accuracy: {}'.format(
                select_gateway.gateway_id, T_cur, report.test_loss, report.accuracy))
            ...
            if logger is not None:
                ...
                logger.log_value('cs_gamma', self.gateways[0].cs_gamma, int(T_cur * 1000))
